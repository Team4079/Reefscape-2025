...
public class RobotParameters {
  ...
  public static class SwerveParameters {
    ...
    public static class PIDParameters {
      ...
      public static final PIDVController DRIVE_PID_AUTO = new PIDVController(7.0, 0.0, 0.00, 0.5);
      public static final PIDVController DRIVE_PID_TELE = new PIDVController(1.5, 0.0, 0.0, 0.0);
  ...
  public static class CoralManipulatorParameters {
    private CoralManipulatorParameters() {
      // Private constructor to prevent instantiation
    }
